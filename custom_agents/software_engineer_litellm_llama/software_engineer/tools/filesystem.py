...
def configure_edit_approval(require_approval: bool, tool_context: ToolContext) -> Dict[str, Any]:
    ...
    Note: This only affects file editing. For shell command approvals, use the
    'configure_shell_approval' function instead.
...
configure_file_edit_approval_tool = FunctionTool(configure_edit_approval)
configure_approval_tool = configure_file_edit_approval_tool  # Keep original name for backward compatibility
