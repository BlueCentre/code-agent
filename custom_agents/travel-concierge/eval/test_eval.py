...
def test_inspire():
    ...
    AgentEvaluator.evaluate(
        ...
        num_runs=4,
        initial_session_file=str(pathlib.Path(__file__).parent / "itinerary_empty_default.json"),
    )
...
def test_pretrip():
    ...
    AgentEvaluator.evaluate(
        ...
        num_runs=4,
        initial_session_file=str(pathlib.Path(__file__).parent / "itinerary_seattle_example.json"),
    )
