...
for user_input in user_inputs:
    ...
    with requests.post(RUN_ENDPOINT, data=json.dumps(DATA), headers=HEADERS, stream=True) as r:
        for chunk in r.iter_lines():  # or, for line in r.iter_lines():
            ...
            function_calls = [e["functionCall"] for e in event["content"]["parts"] if "functionCall" in e]
            function_responses = [e["functionResponse"] for e in event["content"]["parts"] if "functionResponse" in e]
            ...
            if function_calls:
                ...
                for function_response in function_responses:
                    ...
                    application_payload = json.dumps(function_response["response"], indent=2)
