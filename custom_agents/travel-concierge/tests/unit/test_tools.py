...
class TestAgents(unittest.TestCase):
    ...
    def test_memory(self):
        ...
        self.assertEqual(self.tool_context.state["itinerary_datetime"], "12/31/2025 11:59:59")

    def test_places(self):
        self.tool_context.state["poi"] = {"places": [{"place_name": "Machu Picchu", "address": "Machu Picchu, Peru"}]}
