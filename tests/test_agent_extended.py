...
def test_auto_approve_edit(mocker):
    ...
    with (
        patch(
            "code_agent.agent.agent.litellm.completion",
            side_effect=[response, create_text_response("Edit complete")],
        ),
...
def test_auto_approve_command(mocker):
    ...
    with (
        patch(
            "code_agent.agent.agent.litellm.completion",
            side_effect=[response, create_text_response("Command executed")],
        ),
        patch(
            "code_agent.agent.agent.run_native_command",
...
def test_error_in_tool_execution(agent_with_mock_config, mocker):
    ...
    with (
        patch(
            "code_agent.agent.agent.read_file",
