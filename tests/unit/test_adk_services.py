...
from code_agent.adk.services import SessionSecurityManager # Import placeholder for mocking
...
async def test_create_session(event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock, mock_security_manager: MagicMock): # Add mock_security_manager
...
async def test_get_session(event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock, mock_security_manager: MagicMock): # Add mock_security_manager
...
@patch("code_agent.adk.services.CodeAgentADKSessionManager.get_session", new_callable=AsyncMock)
async def test_add_user_message(mock_get_session, event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock): # Patch manager's get_session
...
@patch("code_agent.adk.services.CodeAgentADKSessionManager.get_session", new_callable=AsyncMock)
async def test_add_assistant_message(mock_get_session, event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock): # Patch manager's get_session
...
@patch("code_agent.adk.services.CodeAgentADKSessionManager.get_session", new_callable=AsyncMock)
async def test_add_assistant_message_with_tool_calls(mock_get_session, event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock): # Patch manager's get_session
...
@patch("code_agent.adk.services.CodeAgentADKSessionManager.get_session", new_callable=AsyncMock)
async def test_add_tool_result(mock_get_session, event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock): # Patch manager's get_session
...
@patch("code_agent.adk.services.CodeAgentADKSessionManager.get_session", new_callable=AsyncMock)
async def test_add_system_message(mock_get_session, event_loop, session_manager: CodeAgentADKSessionManager, mock_session: MagicMock): # Patch manager's get_session
