...
def create_model(
    ...
    For ai_studio (Gemini), returns the model name string.
    ...
    Returns:
        An initialized BaseLlm instance (Gemini, LiteLlm, or OllamaLlm) or the model name string for ai_studio.
    ...
    # Get API key based on provider (needed for Gemini and LiteLLM)
